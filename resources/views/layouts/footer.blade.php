    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <p class="small">
                    We are committed to delivering the best Task Management Servce. Our goal is to provide top-notch
                    solutions
        ...
        <div class="text-center">
            <p class="mb-0 small">&copy; {{ date('Y') }} Ahmad AM Obeidat. All Rights Reserved.</p>
        </div>
    </div>
</footer>
